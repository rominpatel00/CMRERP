...
/*        if(!is_dir(BACKUPS_FOLDER)){
        ...
        if($theme != 'TechERP'){
            copy(APPPATH . 'views/themes/TechERP/template_parts/contract_attachments.php',APPPATH . 'views/themes/' . active_clients_theme() . '/template_parts/contract_attachments.php');
        }
